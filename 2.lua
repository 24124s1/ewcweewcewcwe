...
library.themes = {
    {
        ...
        theme = {
            ...
            ['Border 1']                  = fromrgb(90, 60, 180);
            ['Border 2']                  = fromrgb(40, 20, 80);
            ['Border 3']                  = fromrgb(20, 10, 40);
            ['Primary Text']              = fromrgb(255, 230, 255);
            ['Group Background']          = fromrgb(25, 15, 35);
            ['Selected Tab Background']   = fromrgb(35, 20, 50);
            ['Unselected Tab Background'] = fromrgb(15, 10, 20);
            ['Selected Tab Text']         = fromrgb(230, 200, 255);
            ['Unselected Tab Text']       = fromrgb(160, 140, 190);
            ['Section Background']        = fromrgb(30, 20, 45);
            ['Option Text 1']             = fromrgb(240, 210, 255);
            ['Option Text 2']             = fromrgb(200, 180, 230);
            ['Option Text 3']             = fromrgb(150, 130, 190);
            ['Option Border 1']           = fromrgb(100, 60, 180);
            ['Option Border 2']           = fromrgb(30, 15, 50);
            ['Option Background']         = fromrgb(40, 25, 60);
            ["Risky Text"]                = fromrgb(220, 60, 140);
            ["Risky Text Enabled"]        = fromrgb(255, 100, 200);
        }
    },
    {
        name = 'Midnight',
